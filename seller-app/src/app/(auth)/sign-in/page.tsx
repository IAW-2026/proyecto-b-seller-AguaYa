...
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-950 flex flex-col items-center justify-center px-4">
            <div className="mb-8 text-center">
                ...
                <h1 className="text-3xl font-bold text-slate-800 dark:text-white">AguaYa Seller</h1>
                <p className="text-slate-500 dark:text-slate-400 mt-2">Iniciá sesión para gestionar tu negocio</p>
            </div>
            <SignIn
                appearance={{
                    elements: {
