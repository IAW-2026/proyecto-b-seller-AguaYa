    ...
    <div className="space-y-6 animate-pulse">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-white/30 bg-white/20 p-5 shadow-lg shadow-black/5 backdrop-blur-xl">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        {Array.from({ length: 2 }).map((_, i) => (
          <div key={i} className="rounded-2xl border border-white/30 bg-white/20 p-6 shadow-lg shadow-black/5 backdrop-blur-xl">
