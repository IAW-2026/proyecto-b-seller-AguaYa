  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 animate-pulse">
      {Array.from({ length: 10 }).map((_, i) => (
        <div key={i} className="flex flex-col rounded-xl border border-white/30 bg-gradient-to-br from-white/30 to-slate-100/30 p-3 shadow-lg shadow-black/5 backdrop-blur-xl">
